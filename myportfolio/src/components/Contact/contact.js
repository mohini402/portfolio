...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_ld0bwwo", "template_h1o3sht", form.current, {
        publicKey: "8bVa96VeNrjkmXaxx",
      })
      .then(
        () => {
          console.log("SUCCESS!");
    ...
    <section className="contactPage">
      ...
      <div className="contact">
        <form className="contactForm" ref={form} onSubmit={sendEmail}>
          <label className="firstLabel">Enter First Name*</label>
          <input type="text" className="firstName" placeholder="First Name" name="your_name" />
          <label>Enter Your Email*</label>
          <input type="email" className="email1" placeholder="Your email" name="your_email" />
